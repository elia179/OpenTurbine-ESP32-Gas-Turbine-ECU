...
function registryGlowSubcards(c, index) {
  ...
  return `<div class="hw-item-card registry-subcard" style="grid-column:1/-1;margin:.35rem 0 0">
    ...
    <div class="registry-card-editor" style="display:block"><div class="hw-grid">
      ...
      <div class="hw-field"><span class="hw-label">Preheat duration (ms)</span><span class="hw-desc">Time for the Pre-Heat sequence step to ramp this plug before holding.</span><input type="number" min="0" max="3600000" step="100" value="${Number(c.ignition_preheat_ms)}" oninput="updateRegistryChannel('output',${index},'ignition_preheat_ms',+this.value)"></div>

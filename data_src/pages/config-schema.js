...
const ALL_CONFIG_SCHEMA = [
  ...
  { title: 'Oil Pressure Safety', id: 'oil-safety-section', sectionNote:'Independent oil-pressure, current, and flow protections. Startup oil requirements remain in the startup Sequence blocks where they act.', fields: [
    { key:'oil_rm',  path:['oil','running_min'],        label:'Running Low-Pressure Shutdown', unitType:'press', desc:'Shown as a visual advisory on the Dashboard while RUNNING. The ECU shuts down below this value only when low-oil safety is enabled and the Low-Oil Confirmation time expires.', step:0.1, min:0, max:20, basic:true },

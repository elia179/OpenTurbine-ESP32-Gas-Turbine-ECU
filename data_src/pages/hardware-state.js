...
const ACT_DEPENDENCIES = {
  ...
  glow_plug: { name:'Glow plug', logs:['glow'], rules:[16], blocks:['PreHeat'], functions:['Pre-Heat sequence block','glow logging','rules driving glow plug'] },
  ...
  igniter: { name:'Igniter 1', rules:[9], blocks:['IgniterOn','IgniterOff','PreHeat'], functions:['Ignition sequence blocks','rules driving igniter'] },

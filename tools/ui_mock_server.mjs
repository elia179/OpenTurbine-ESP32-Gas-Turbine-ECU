...
function fullTelemetry() {
  return {
    ...
    rpm_limit: 95000, rpm_limit_active: true, n2_rpm_limit: 30000, n2_limit: 30000, n2_limit_active: true,
    tot_limit: 720, tot_limit_active: true, egt_source: 1, egt_limit: 720, egt_limit_active: true,
    startup_egt_limit: 0, oil_running_min: 1.2, oil_running_min_active: true,
    oil_temp_limit: 115, oil_temp_limit_active: true, tit_limit: 900, tit_limit_active: false,
    fuel_press_min: 1.1, fuel_press_min_active: true, batt_volt_min: 10.5, batt_volt_min_active: true,
    tot_rise_rate: 2.5,

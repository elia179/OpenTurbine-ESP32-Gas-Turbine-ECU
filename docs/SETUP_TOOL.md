...
This document describes the OpenTurbine 2.4.1 package and setup workflow. A 2.4.1
release package must contain firmware and web assets built from the same commit
and must report version `2.4.1` during post-install verification.

OpenTurbine 2.4.1 ships with Setup Tool 0.7.3. The Windows setup tool provides
...
Before packaging 2.4.1, also follow [`V2_MIGRATION.md`](V2_MIGRATION.md) and

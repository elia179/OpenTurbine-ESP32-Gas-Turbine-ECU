# OpenTurbine 2.3.6 developer and validation documentation
...
9. Confirm the firmware, package manifest, changelog, release title, and website all identify `2.3.6`.
